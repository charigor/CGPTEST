...
new Vue({
  ...
  methods: {
    ...
    createClient: function createClient() {
      ...
      axios.post("/clients", this.form).then(function (response) {
        _this.clients = response.data.clients;
        $(_this.$refs.modalClients).modal('hide');
    ...
    updateClient: function updateClient() {
      ...
      axios.put("/clients/".concat(this.form.id), this.form).then(function (response) {
        _this2.clients.data.filter(function (item, self) {
        ...
        $(_this2.$refs.modalClients).modal('hide');
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          toast: true,
          position: 'top-end',
          icon: 'success',
    ...
    deleteClient: function deleteClient(id) {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        if (result.isConfirmed) {
          axios["delete"]("/clients/".concat(id)).then(function (response) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
              toast: true,
              position: 'top-end',
              icon: 'success',
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _this4.show = url == '/api/companies' ? false : true;
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/pages/clients.js");
