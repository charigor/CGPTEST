...
new Vue({
  ...
  methods: {
    ...
    createCompany: function createCompany() {
      ...
      axios.post("/companies", this.form // { headers: {"Authorization" : `Bearer ${localStorage.getItem('token')}`}}
      ).then(function (response) {
        _this.companies = response.data.companies;
        $(_this.$refs.modalCompanies).modal('hide'); // toast.fire({
        //     icon: 'success',
        //     title: response.data.message
        // })
        // Fire.$emit('ActionCategory');
      })["catch"](function (error) {// this.errors.record(error.response.data)
        // this.$Progress.fail()
      });
    },
    updateCompany: function updateCompany() {
      ...
      axios.put("/companies/".concat(this.form.id), this.form // { headers: {"Authorization" : `Bearer ${localStorage.getItem('token')}`}}
      ).then(function (response) {
        // console.log(response.data.companies)
        _this2.companies.data.map(function (item) {
        ...
        $(_this2.$refs.modalCompanies).modal('hide'); // toast.fire({
        //     icon: 'success',
        //     title: response.data.message
        // })
        // Fire.$emit('ActionCategory');
      })["catch"](function (error) {
        console.log(error); // this.errors.record(error.response.data)
        // this.$Progress.fail()
      });
    },
    deleteCompany: function deleteCompany(id) {
      ...
      axios["delete"]("/companies/".concat(id) // { headers: {"Authorization" : `Bearer ${localStorage.getItem('token')}`}}
      ).then(function (response) {
        _this3.companies = response.data.companies;
        $(_this3.$refs.modalCompanies).modal('hide'); // toast.fire({
        //     icon: 'success',
        //     title: response.data.message
        // })
        // Fire.$emit('ActionCategory');
